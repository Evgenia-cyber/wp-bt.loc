        ...
        <header class="main-header"<?php echo bluerex_get_background('header_bg')?>>
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <?php wp_nav_menu(array('theme_location' => 'header_menu', 'container' => FALSE, 'menu_class' => 'navbar-nav ml-auto')) ?>
                ...
                <?php if (get_field('header2')): ?>
                    ...
                    <div class="main-header-buttons">
                        ...
                        if (get_field('header_btn1')):
                            ...
                            ?>
                            <a href="<?php echo esc_url($link['url']) ?>" class="btn btn-pink rounded-pill"><?php echo esc_html($link['title']) ?>
                            </a>
                        <?php endif; ?>
                        <?php
